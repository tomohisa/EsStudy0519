...
param clusteringTableName string = 'esstudy0519clustering'

@description('The name of the blob container used for Orleans grain state')
param grainStateBlobContainerName string = 'esstudy0519grainstate'

@description('The name of the queue used for Orleans streaming')
param queueName string = 'esstudy0519queue'
